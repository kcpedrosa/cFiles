...
/* ---------------------------------------------------------------------- */
/* prototypes */
void pe0(void); /* Proj. Euler problem #0 */

/* ---------------------------------------------------------------------- */
/* main function */
/* Do not change the main function. Use the void pe0(void) and
...
int main(void)
{
   ...
   /* help();*/ /* optional help message at start */
    ...
    pe0(); /* Proj. Euler problem #0 */
    LEGOsignals(); /* restore interruption signals */
    return EXIT_SUCCESS;
}

/* ---------------------------------------------------------------------- */
/* Proj. Euler problem #0 */
/* Problem description:
 *
 */
