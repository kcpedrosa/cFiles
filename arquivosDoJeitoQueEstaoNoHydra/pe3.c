 ...
 *   Email: kattine.costa@gmail.com / kcp@poli.br                          *
 *   Webpage: https://github.com/kcpedrosa                                 *
    ...
    /* if(minutes() >= 2) break; */
{
 ...
 long int n;
  n = 600851475143;
long int div = 2, ans = 0, maxfactor;
  while (n != 0)
    {
      if (n % div != 0)
  div = div + 1;
      else
  {
    ...
    if (n == 1)
      {
        printf
    ("%ld is the largest prime factor of the number 600851475143 \n", maxfactor);
        ans = 1;
        break;
      }
  }
